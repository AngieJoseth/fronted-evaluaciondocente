...
export class AppTopBarComponent {
    ...
    constructor(public app: AppMainComponent,
        ...
        this.institution = localStorage.getItem('institution') === 'undefined' ? null :
    ...
    getMegaMenus() {
        this.permissions = localStorage.getItem('permissions') === 'undefined' ? null :
    ...
    getUrlAvatar() {
        if (this.user) {
            if (this.user.avatar) {
                this.urlAvatar = this.STORAGE_URL + this.user.avatar.uri;
            } else {
                if (this.user.sex) {
